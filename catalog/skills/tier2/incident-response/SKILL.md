...
description: Use when the user says "production is down", "run incident response", "start incident protocol", or service is broken and needs immediate restoration. Three-phase protocol — stabilize, investigate, post-mortem — with required `docs/incidents/YYYY-MM-DD-<topic>.md` artifact.
version: "1.0.0"
source: haac-aikit
license: MIT
allowed-tools:
